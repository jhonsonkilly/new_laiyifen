...
public class HeadImageView extends CircleImageView {
    ...
    public void loadBuddyAvatar(String account) {
        ...
        doLoadImage(userInfo != null ? userInfo.getAvatar() : nimUserInfo != null ? userInfo.getAvatar() : null, NimUIKit.getUserInfoProvider()
...
//                .into(this);
        ...
        Glide.with(getContext().getApplicationContext())
                .load(url).asBitmap()
                .centerCrop().placeholder(defaultResId).error(defaultResId).override(thumbSize,thumbSize)
                .into(this);
