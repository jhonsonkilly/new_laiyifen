...
import com.netease.nim.demo.session.action.DistinguishAction;
...
import com.netease.nim.demo.session.action.TeamAUChatAction;
...
import com.netease.nim.demo.session.viewholder.MsgViewHolderBusinessCard;
import com.netease.nim.demo.session.viewholder.MsgViewHolderDefCustom;
import com.netease.nim.demo.session.viewholder.MsgViewHolderDiscount;
import com.netease.nim.demo.session.viewholder.MsgViewHolderDistinguish;
import com.netease.nim.demo.session.viewholder.MsgViewHolderFile;
import com.netease.nim.demo.session.viewholder.MsgViewHolderFriendInfo;
...
import com.netease.nim.demo.session.viewholder.MsgViewHolderYiDianCard;
import com.netease.nim.demo.session.viewholder.SystemMessageMsgImageViewHolder;
import com.netease.nim.demo.session.viewholder.SystemMessageMsgOnlyTextViewHolder;
...
public class SessionHelper {
    ...
    public static void init() {
        sp = NimUIKit.getContext().getSharedPreferences("JurisdictionButton", Context.MODE_PRIVATE);
        // 注册自定义消息附件解析器
    ...
    public static void startP2PSession(Context context, String account, boolean isSystemMessage) {
        startP2PSession(context, account, null, isSystemMessage);
    }
    ...
    public static void startP2PSession(Context context, String account, IMMessage anchor, boolean isSystemMsg) {
        if (!DemoCache.getAccount().equals(account)) {
            if (RobotInfoCache.getInstance().getRobotByAccount(account) != null) {
                ...
                NimUIKit.startP2PSession(context, account, anchor, isSystemMsg);
            }
        } else {
    ...
    private static SessionCustomization getP2pCustomization() {
        if (p2pCustomization == null) {
            ...
            if (Preferences.getRedPacketCanUse()) {
                actions.add(new RedPacketAction());
            }
            actions.add(new YiDianCardAction());
            actions.add(new DiscountAction());
            //            actions.add(new YiDouCardAction());
            ...
            actions.add(new DistinguishAction());
            //发送文件
            ...
            SessionCustomization.OptionsButton infoButton = new SessionCustomization.OptionsButton() {
                ...
                public void onClick(Context context, View view, String sessionId) {
                    ...
                    UserProfileActivity.start(context, sessionId,"陌生人聊天添加");
                }
            };

            infoButton.iconId = R.drawable.icon_im_p2p;
...
//            buttons.add(cloudMsgButton);
    ...
    private static SessionCustomization getTeamCustomization() {
        if (teamCustomization == null) {
            ...
            final TeamAUChatAction audioChatAction = new TeamAUChatAction(AVChatType.AUDIO);
                ...
                public void onActivityResult(Activity activity, int requestCode, int resultCode, Intent data) {
                    if (requestCode == TeamRequestCode.REQUEST_CODE) {
                        ...
                        if (resultCode == Activity.RESULT_OK) {
                            ...
                            ArrayList<String> selectedAccounts = data.getStringArrayListExtra(ContactSelectActivity.RESULT_DATA);
                            audioChatAction.onSelectedAccountsResult(selectedAccounts);
                        } else {
                            audioChatAction.onSelectedAccountFail();
                        }
                    }
                }
...
//            buttons.add(cloudMsgButton);
    ...
    private static void registerViewHolders() {
        ...
        NimUIKit.registerMsgItemViewHolder(SystemMessageOnlyTextAttachment.class, SystemMessageMsgOnlyTextViewHolder.class);
        NimUIKit.registerMsgItemViewHolder(SystemMessageImageNewAttachment.class, SystemMessageMsgImageViewHolder.class);
        NimUIKit.registerMsgItemViewHolder(SysFriendInfoAttachment.class, MsgViewHolderFriendInfo.class);
        NimUIKit.registerMsgItemViewHolder(YiDianCardAttachment.class, MsgViewHolderYiDianCard.class);
        NimUIKit.registerMsgItemViewHolder(DiscountAttachment.class, MsgViewHolderDiscount.class);
        ...
        NimUIKit.registerMsgItemViewHolder(DistinguishAttachment.class, MsgViewHolderDistinguish.class);
        NimUIKit.registerMsgItemViewHolder(com.netease.nim.uikit.session.extension.DistinguishAttachment.class, MsgViewHolderDistinguish.class);
    }
    ...
    private static void setSessionListener() {
        SessionEventListener listener = new SessionEventListener() {
            ...
            public void onAvatarClicked(Context context, IMMessage message) {
                ...
                UserProfileActivity.start(context, message.getFromAccount(),"陌生人聊天添加");
            }
