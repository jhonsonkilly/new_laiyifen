...
public class MsgViewHolderSticker extends MsgViewHolderBase {
    ...
    protected void bindContentView() {
        ...
        //                .into(baseView);
        Glide.with(context).load(StickerManager.getInstance().getStickerUri(attachment.getCatalog(), attachment.getChartlet())).asGif().diskCacheStrategy(DiskCacheStrategy.SOURCE).into(baseView);
    }
