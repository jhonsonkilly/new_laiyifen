...
public class TeamAVChatActivity extends UI {
    ...
    protected void onResume() {
        ...
        if (NimApplication.chatStatus == 1) {
            System.out.println();
        }
    }
    ...
    private void findLayouts() {
        ...
        if (NimApplication.chatStatus == 1) {
            surfaceLayout.findViewById(R.id.r2).setVisibility(View.GONE);


        } else {
            surfaceLayout.findViewById(R.id.r2).setVisibility(View.VISIBLE);
    ...
    private void showReceivedCallLayout() {
        ...
        if (NimApplication.chatStatus == 0) {
            textView.setText(teamName + " 的视频通话");
        } else {
            textView.setText(teamName + " 的语音通话");
        }
    ...
    private void startRtc() {
        ...
        AVChatManager.getInstance().joinRoom2(roomId, AVChatType.VIDEO, new AVChatCallback<AVChatData>() {
            ...
            public void onSuccess(AVChatData data) {
                ...
                /*if (data.getExtra().equals("视频")) {
                    NimApplication.chatStatus = 0;
                } else if (data.getExtra().equals("音频")) {
    ...
    private View.OnClickListener settingBtnClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            } else if (id == R.id.avchat_enable_video) {
                // 视频
                AVChatManager.getInstance().muteLocalVideo(videoMute = !videoMute);
                // 发送控制指令
                byte command = videoMute ? AVChatControlCommand.NOTIFY_VIDEO_OFF : AVChatControlCommand.NOTIFY_VIDEO_ON;
            ...
            } else if (id == R.id.avchat_enable_audio) {
                // 麦克风开关
            ...
            } else if (id == R.id.avchat_shield_user) {
                // 屏蔽用户音频
                disableUserAudio();
