 ...
 * 用于展示收藏夹里的视频和图片
 */
public class ShowCollectActivity extends UI implements View.OnClickListener {
    public static final String DATA = "SHOWCOLLECTACTIVITY";
    ...
    public static void startActivity(Activity activity, Object data) {
        Intent intent = new Intent();
        intent.putExtra(DATA, (Serializable) data);
        intent.setClass(activity, ShowCollectActivity.class);
