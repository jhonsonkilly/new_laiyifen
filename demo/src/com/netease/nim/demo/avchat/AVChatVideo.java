...
public class AVChatVideo implements View.OnClickListener, ToggleListener {
    ...
    private void findViews() {
        ...
        refuseTV = (ImageView) refuse_receive.findViewById(R.id.refuse);
        receiveTV = (ImageView) refuse_receive.findViewById(R.id.receive);
        ...
        //等待接听布局
        mCallView = root.findViewById(R.id.video_call_layout);
        ImageView hangup = (ImageView) mCallView.findViewById(R.id.hangup);
        mName = (TextView) mCallView.findViewById(R.id.name);
        mIcon = (HeadImageView) mCallView.findViewById(R.id.icon);
    ...
    public void onCallStateChange(CallStateEnum state) {
        ...
        switch (state) {
            ...
            case INCOMING_VIDEO_CALLING:
                ...
                setTopRoot(false);
                setMiddleRoot(true);
                middleRoot.setBackgroundResource(R.drawable.avcall_bg);
                setBottomRoot(false);
                setCallRoot(false);
    ...
    private void showProfile() {
        ...
        mIcon.loadBuddyAvatar(account);
        nickNameTV.setText(NimUserInfoCache.getInstance().getUserDisplayName(account));
        mName.setText(NimUserInfoCache.getInstance().getUserDisplayName(account));
    ...
    private void setCallRoot(boolean visible) {
        mCallView.setVisibility(visible ? View.VISIBLE : View.GONE);
    }
