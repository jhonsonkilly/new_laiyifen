...
public class TeamAVChatHelper {
    ...
    public String buildContent(String roomName, String teamID, List<String> accounts, String teamName,String meetingType) {
        ...
        json.put(MEETING_TYPE, meetingType);
        ...
        public void onEvent(CustomNotification customNotification) {
            try {
                ...
                if (isTeamAVChatInvite(jsonObject)) {
                    String meetingType = jsonObject.getString(MEETING_TYPE);
                    if (meetingType.equals("1")) {
                        NimApplication.chatStatus = 1;
                    } else if (meetingType.equals("2")) {
