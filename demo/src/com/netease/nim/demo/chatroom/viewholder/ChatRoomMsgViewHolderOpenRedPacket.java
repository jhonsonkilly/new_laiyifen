...
public class ChatRoomMsgViewHolderOpenRedPacket extends ChatRoomMsgViewHolderBase {
    ...
    public ChatRoomMsgViewHolderOpenRedPacket(BaseMultiItemFetchLoadAdapter adapter) {
        super(adapter);
...
//            NIMRedPacketClient.startRpDetailActivity((Activity) context, attachment.getRedPacketId());
        ...
        public void updateDrawState(TextPaint ds) {
            ...
            ds.setColor(context.getResources().getColor(R.color.red_packet_toolbar));
