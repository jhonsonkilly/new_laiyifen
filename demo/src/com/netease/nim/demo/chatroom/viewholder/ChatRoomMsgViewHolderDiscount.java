 ...
 */
public class ChatRoomMsgViewHolderDiscount extends ChatRoomMsgViewHolderBase {
    ...
    public ChatRoomMsgViewHolderDiscount(BaseMultiItemFetchLoadAdapter adapter) {
        super(adapter);
    }
