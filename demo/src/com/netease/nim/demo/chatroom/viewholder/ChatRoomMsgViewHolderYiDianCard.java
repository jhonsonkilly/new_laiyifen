 ...
 */
public class ChatRoomMsgViewHolderYiDianCard extends ChatRoomMsgViewHolderBase {
    ...
    public ChatRoomMsgViewHolderYiDianCard(BaseMultiItemFetchLoadAdapter adapter) {
        super(adapter);
    }
