...
public class ChatRoomRedPacketAction extends BaseAction {

    public ChatRoomRedPacketAction() {
            ...
            public void onSendSuccess(String s) {
                try {
                    ...
                    if (model.getCode().equals("0")) {
                        ...
                        IMMessage message = ChatRoomMessageBuilder.createChatRoomCustomMessage(getAccount(), attachment);
