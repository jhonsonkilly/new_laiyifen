...
public class ChatRoomActivity extends UI {
    ...
    public static void start(Context context, String roomId, String title) {
        Intent intent = new Intent();
        intent.setClass(context, ChatRoomActivity.class);
        intent.putExtra(EXTRA_ROOM_ID, roomId);
        intent.putExtra(EXTRA_ROOM_NAME, title);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTitle = getIntent().getStringExtra(EXTRA_ROOM_NAME);
...
//                showDialog();
                ...
                show.putExtra("roomInfo", (Serializable) roomInfo);
                show.putExtra("title",mTitle);
                show.setClass(ChatRoomActivity.this,MemberActivity.class);
                startActivity(show);
            }
        });
