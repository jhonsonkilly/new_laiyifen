...
public class DrawableUtils {
    ...
    public static StateListDrawable mainSelector(Drawable normalState, Drawable pressedState) {
        StateListDrawable bg = new StateListDrawable();
        bg.addState (new int[]{android.R.attr.state_checked}, pressedState);
        bg.addState (new int[]{android.R.attr.state_checkable}, normalState);
        bg.addState (new int[]{}, normalState);
        return bg;
    }
