 ...
 */
public class ProductImpl implements ProductPresent {
    ...
    public ProductImpl(ProductView mView, int ImplType) {
        super();
        this.mView = mView;
    ...
    public ProductImpl(ProductWebView webView, int ImplType) {
        super();
