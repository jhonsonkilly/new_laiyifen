...
public class ServiceAssuranceTominus extends PopupWindow implements View.OnClickListener {
    ...
    public ServiceAssuranceTominus(Activity context, List<ProductBean.securityVOList> list,int themcolor) {
        super(context);
        this.context = context;
        this.list = list;
        LayoutInflater inflater = (LayoutInflater) context
                .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        popupView = inflater.inflate(R.layout.produtdetail_popup_service_from_bottom_top, null);
    ...
    private void init() {
        ...
        text_minukonw = (TextView) popupView.findViewById(R.id.text_know);
        text_minukonw.setBackgroundColor(context.getResources().getColor(themcolor));
