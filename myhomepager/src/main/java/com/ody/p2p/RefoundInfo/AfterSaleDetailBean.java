...
public class AfterSaleDetailBean extends BaseRequestBean {
    ...
    public class Data implements Serializable{
        ...
        private String courierNumber;//用户填的物流单号
        ...
        public String logisticsCompany;//用户填的物流公司

        public String returnCourierNumber;//换货商品从商家递出的物流单号
        ...
        public String serviceReturnReason;//客服选择的退货原因(验货没通过)

        public String auditReason;//审核没通过原因
