...
public class CountDownForDetailView extends LinearLayout{
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == COUNT_MES){
                if (countTime > 0){
                    ...
                    countTime -= 1;
                    Log.d("couttime"," "+getDay(countTime)+":"+" "+getHour(countTime)+":"+" "+getMin(countTime)+":"+" "+getSec(countTime)+":");
    ...
    public CountDownForDetailView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public CountDownForDetailView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void initView(){
        mLayout = (LinearLayout) LayoutInflater.from(getContext()).inflate(R.layout.layout_count_down_for_detail,null);
        addView(mLayout);
