 ...
 */
public class OdySnapPageLayout extends ViewGroup {
    ...
    public OdySnapPageLayout(Context context, AttributeSet att) {
        this(context, att, 0);
    }

    public OdySnapPageLayout(Context context, AttributeSet attrs, int defStyle) {
...
//			//必须调用该方法，否则不一定能看到滚动效果
     ...
     * @param scrollType
     */
    public void setScrollType(boolean scrollType) {
...
//                        if (mPageSnapedListener != null) {
//                            mPageSnapedListener.onSnapedCompleted(1);
//                        }
                    } else {
                        if (mPageBottom != null && mPageBottom.isAtTop()) {
                            scrollBy(0, deltaY);
//                            if (mPageSnapedListener != null) {
//                                mPageSnapedListener.onSnapedCompleted(0);
//                            }
                        }
                    }
                }
    ...
    public interface ScrollViewListener {
        ...
        void onScrollChanged(OdySnapPageLayout scrollView, int x, int y, int oldx, int oldy);
