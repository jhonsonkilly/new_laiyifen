...
public class ProductBannerPager extends FrameLayout {
    ...
    private ArrayList<BannerProductBean> bannerList = new ArrayList<BannerProductBean>();
    ...
    public ProductBannerPager(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context);
    }

    public ProductBannerPager(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
    ...
    public void setIndicatorPosition(int gravity, int bottomMargin,
        ...
        LayoutParams p = new LayoutParams(
                ...
                LayoutParams.WRAP_CONTENT);
        p.gravity = gravity;
        p.bottomMargin = user_bottomMargin;
    ...
    public void setEasyData(ArrayList<BannerProductBean> bannerList) {
        ...
        pagerAdapter = new ProductBannerAdapter(getContext(), bannerList);
        pagerAdapter.setInfiniteLoop(IS_LOOPER);
    ...
    public void setIndicator(int size){
        for(int i=0;i<size;i++){
            ...
            imageViews[i].setPadding(10,0,10,0);
            if (i == 0) {
