...
public class FlowLayout extends ViewGroup {
     ...
     */
    OnFlowTagClickListener mOnTagClickListener;

    /**
     * the tag select event callback
     */
    OnFlowTagSelectListener mOnTagSelectListener;
    ...
    public void setOnTagClickListener(OnFlowTagClickListener onTagClickListener) {
        this.mOnTagClickListener = onTagClickListener;
    }

    public void setOnTagSelectListener(OnFlowTagSelectListener onTagSelectListener) {
