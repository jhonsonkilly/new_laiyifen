...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private int tabBackgroundResId = R.color.background_color;
    ...
    public void setTabsTitleStyle() {
        ...
        // 设置Tab Indicator的颜色
        setIndicatorColor(getResources().getColor(R.color.CFF6900));
        // 设置选中Tab文字的颜色 (这是我自定义的一个方法)
        setSelectedTextColor(getResources().getColor(R.color.CFF6900));
        // 取消点击Tab时的背景色
        setTextColor(getResources().getColor(R.color.grey_text_color));
        setTabBackground(0);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        RectF roundRect3 = new RectF();
        roundRect3.left = lineLeft - 15;
        roundRect3.top = height - indicatorHeight;
        roundRect3.right = lineRight - 15;
        roundRect3.bottom = height;
        //半径
        canvas.drawRect(roundRect3, rectPaint);
