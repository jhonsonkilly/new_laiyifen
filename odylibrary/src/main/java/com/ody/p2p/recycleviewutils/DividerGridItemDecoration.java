...
public class DividerGridItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public void drawHorizontal(Canvas c, RecyclerView parent) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            final RecyclerView.LayoutParams params = (RecyclerView.LayoutParams) child
                    .getLayoutParams();
            final int left = child.getLeft() - params.leftMargin + size;
            final int right = child.getRight() + params.rightMargin
                    + mDivider.getIntrinsicWidth() + size;
            final int top = child.getBottom() + params.bottomMargin + size;
    ...
    public void drawVertical(Canvas c, RecyclerView parent) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            final int bottom = child.getBottom() + params.bottomMargin + size;
            final int left = child.getRight() + params.rightMargin + size;
