...
//    public static final String GET_SHOP_CATEGORY_ID = BASEURL + "/back-product-web/merchantProductAppAction/getCategoryTreeApp.do";//获取店铺分类ID
    ...
    public static final String COUNTFAVOTITE = BASEURL + "/ouser-center/api/favorite/countFavorite.do";// 关注数量


    public static final String PERSONALDATA = BASEURL + "/api/my/user/info";//


    public static final String QIYUMES = BASEURL+ "/customer/user/getInfo.do";//

    public static final String POLICY = BASEURL+ "/im/appModule";//


    public static final String GUANGGAO = BASEURL+ "/api/dolphin/list";//
}
