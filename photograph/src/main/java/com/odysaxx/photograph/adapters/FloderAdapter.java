...
public class FloderAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.photoNumTV.setText(floder.getPhotoList().size() + mContext.getString(R.string.spread));
        Glide.with(mContext).load(floder.getPhotoList().get(0)).into(holder.photoIV);
        return convertView;
    }
