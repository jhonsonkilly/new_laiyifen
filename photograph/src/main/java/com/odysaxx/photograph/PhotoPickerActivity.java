...
import com.odysaxx.photograph.adapters.FloderAdapter;
import com.odysaxx.photograph.adapters.PhotoAdapter;
import com.odysaxx.photograph.beans.Photo;
import com.odysaxx.photograph.beans.PhotoFloder;
import com.odysaxx.photograph.utils.LogUtils;
import com.odysaxx.photograph.utils.OtherUtils;
import com.odysaxx.photograph.utils.PhotoUtils;
...
public class PhotoPickerActivity extends Activity implements PhotoAdapter.PhotoClickCallBack {
    ...
    private List<String > mPhotoLists = new ArrayList<String>();
    private ArrayList<String> mSelectList = new ArrayList<String>();
    private List<PhotoFloder> floderList=new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ALL_PHOTO = getString(R.string.all_photos);
        initIntentParams();
        initView();
    ...
    private void initIntentParams() {
        int take_photo = getIntent().getIntExtra("take_photo", 0);
        if (take_photo==100){
            showCamera();
            finish();
        }
    ...
    private void getPhotosSuccess() {
        ...
        for (Map.Entry<String, PhotoFloder> entry : mFloderMap.entrySet()) {
            floderList.add(entry.getValue());
            mPhotoLists.addAll(entry.getValue().getPhotoList());
        }
