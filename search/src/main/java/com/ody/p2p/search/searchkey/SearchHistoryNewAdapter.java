 ...
 * 搜索历史对应的adapter,未走接口
 */
public class SearchHistoryNewAdapter extends RecyclerView.Adapter<SearchHistoryNewAdapter.ViewHolder> {

    private List<SearchRiCiEntity> mData;
    ...
    public SearchHistoryNewAdapter() {
        mData = new ArrayList<>();
    }

    public void setDatas(List<SearchRiCiEntity> allSearchData) {
        mData.clear();
    ...
    @Override
    public SearchHistoryNewAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(final SearchHistoryNewAdapter.ViewHolder holder, final int position) {
        SearchRiCiEntity searchRiCiBean = mData.get(position);
        try {
    ...
    public SearchRiCiEntity getItem(int position){
