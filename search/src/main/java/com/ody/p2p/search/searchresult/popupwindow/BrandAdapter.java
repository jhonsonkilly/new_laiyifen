 ...
 */
public class BrandAdapter extends RecyclerView.Adapter<BrandAdapter.ClassViewHolder>{

    private List<ClassBean> classList;
    private Context context;


    public BrandAdapter(List<ClassBean> classList, Context context) {
    ...
    public ClassViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ClassViewHolder holder = new ClassViewHolder(LayoutInflater.from(context).inflate(R.layout.item_grid_brand, parent, false));
        return holder;
    }
